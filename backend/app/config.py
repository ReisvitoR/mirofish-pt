...
Carregamento unificado de configurações a partir do arquivo .env na raiz do projeto
"""
...
class Config:
    ...
    # Configuração JSON - desabilitar escape ASCII, exibir caracteres unicode diretamente (em vez de formato \uXXXX)
    JSON_AS_ASCII = False
