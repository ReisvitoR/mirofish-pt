...
Lê nós do grafo Zep e filtra aqueles que correspondem a tipos de entidade predefinidos
"""
...
class EntityNode:
    ...
    def get_entity_type(self) -> Optional[str]:
        """Obtém o tipo da entidade (excluindo o rótulo padrão Entity)"""
...
class ZepEntityReader:
    ...
    3. Obter as arestas relacionadas e informações de nós associados para cada entidade
    """
    ...
    def _call_with_retry(
        ...
        """
        Chamada à API Zep com mecanismo de retry
        
        Args:
            func: Função a ser executada (lambda sem parâmetros ou callable)
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Obtém todos os nós do grafo (com paginação)
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Obtém todas as arestas do grafo (com paginação)
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Obtém todas as arestas relacionadas ao nó especificado (com mecanismo de retry)
        ...
        """
        try:
            # Chamar API Zep com mecanismo de retry
    ...
    def filter_defined_entities(
        ...
        """
        Filtra nós que correspondem a tipos de entidade predefinidos
        
        Lógica de filtragem:
        - Se os Labels do nó contêm apenas "Entity", significa que a entidade não corresponde aos tipos predefinidos, será ignorada
        - Se os Labels do nó contêm rótulos além de "Entity" e "Node", significa que corresponde ao tipo predefinido, será mantida
        
        Args:
            graph_id: ID do grafo
            defined_entity_types: Lista de tipos de entidade predefinidos (opcional, se fornecida apenas esses tipos serão mantidos)
        ...
        # Obter todas as arestas (para busca de associações posteriores)
        all_edges = self.get_all_edges(graph_id) if enrich_with_edges else []
        
        # Construir mapeamento de UUID do nó para dados do nó
        ...
        for node in all_nodes:
            ...
            # Lógica de filtragem: Labels devem conter rótulos além de "Entity" e "Node"
            custom_labels = [l for l in labels if l not in ["Entity", "Node"]]
            
            if not custom_labels:
                # Apenas rótulos padrão, ignorar
                continue
            ...
            # Criar objeto do nó de entidade
            entity = EntityNode(
                uuid=node["uuid"],
                name=node["name"],
                labels=labels,
            ...
            if enrich_with_edges:
                ...
                # Obter informações básicas dos nós relacionados
                related_nodes = []
    ...
    def get_entity_with_context(
        ...
        """
        Obtém uma única entidade e seu contexto completo (arestas e nós associados, com mecanismo de retry)
    ...
    def get_entities_by_type(
        ...
        """
        Obtém todas as entidades de um tipo especificado
        
        Args:
            graph_id: ID do grafo
            entity_type: Tipo da entidade (ex: "Student", "PublicFigure", etc.)
