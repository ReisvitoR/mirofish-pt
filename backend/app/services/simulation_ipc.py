...
2. O script de simulação faz polling no diretório de comandos, executa os comandos e escreve respostas no diretório responses/
3. Flask faz polling no diretório de respostas para obter os resultados
"""
...
class CommandType(str, Enum):
    """Tipo de comando"""
    INTERVIEW = "interview"           # Entrevista de um único Agente
    BATCH_INTERVIEW = "batch_interview"  # Entrevista em lote
    CLOSE_ENV = "close_env"           # Encerrar ambiente
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        Raises:
            TimeoutError: Tempo limite ao aguardar resposta
        """
        ...
        # Tempo limite
        logger.error(f"Tempo limite ao aguardar resposta IPC: command_id={command_id}")
        ...
        raise TimeoutError(f"Tempo limite ao aguardar resposta do comando ({timeout}s)")
    ...
    def send_interview(
        ...
        """
        Envia comando de entrevista de um único Agente
        ...
        Args:
            ...
            platform: Plataforma especificada (opcional)
                ...
                - None: Em simulação de duas plataformas, entrevista ambas simultaneamente; em simulação de uma plataforma, entrevista nessa plataforma
            timeout: Tempo limite
            
        Returns:
            IPCResponse, o campo result contém o resultado da entrevista
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Plataforma padrão (opcional, será substituída pelo platform de cada item de entrevista)
                - "twitter": Por padrão, entrevistar apenas na plataforma Twitter
                - "reddit": Por padrão, entrevistar apenas na plataforma Reddit
                - None: Em simulação de duas plataformas, cada Agente é entrevistado em ambas simultaneamente
            timeout: Tempo limite
            
        Returns:
            IPCResponse, o campo result contém todos os resultados das entrevistas
        """
    ...
    def send_close_env(self, timeout: float = 30.0) -> IPCResponse:
        """
        Envia comando de encerramento do ambiente
    ...
    def check_env_alive(self) -> bool:
        ...
        Determina verificando o arquivo env_status.json
        """
...
class SimulationIPCServer:
    ...
    Faz polling no diretório de comandos, executa os comandos e retorna respostas
    """
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        """
        Faz polling no diretório de comandos e retorna o primeiro comando pendente
