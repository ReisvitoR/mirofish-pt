...
def _read_text_with_fallback(file_path: str) -> str:
    ...
    # Tenta usar charset_normalizer para detectar codificação
    encoding = None
    try:
...
def split_text_into_chunks(
    ...
    Args:
        ...
        overlap: Número de caracteres sobrepostos
    ...
    while start < len(text):
        ...
        # Tentar dividir no limite da sentença
        if end < len(text):
            # Procurar o delimitador de sentença mais próximo
            for sep in ['。', '！', '？', '.\n', '!\n', '?\n', '\n\n', '. ', '! ', '? ']:
