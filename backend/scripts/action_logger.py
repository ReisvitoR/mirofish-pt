...
Registra as ações de cada Agent na simulação OASIS, para monitoramento do backend
...
class PlatformActionLogger:
    ...
    def __init__(self, platform: str, base_dir: str):
        """
        Inicializar o registrador de log
...
class SimulationLogManager:
    ...
    def __init__(self, simulation_dir: str):
        ...
        # Configurar o log principal
        self._setup_main_logger()
    
    def _setup_main_logger(self):
        """Configurar o log principal de simulação"""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Obter o registrador de log da plataforma Twitter"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Obter o registrador de log da plataforma Reddit"""
...
class ActionLogger:
    """
    Registrador de ações (compatibilidade com interface antiga)
    Recomenda-se usar SimulationLogManager em vez deste
    """
...
# Instância global de log (compatibilidade com interface antiga)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Obter instância global de log (compatibilidade com interface antiga)"""
