          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Conversar com qualquer indivíduo' }}</span>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Versão de chat rápido do agente de relatórios, com acesso a 4 ferramentas profissionais e memória completa do MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Alinha dados-semente do mundo real com o estado do ambiente simulado, utilizando mecanismos de Memória Global/Local para análise de atribuição profunda entre tempo e espaço</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Algoritmo de travessia em largura baseado em grafos, reconstrói caminhos de propagação de eventos e captura a topologia completa do fluxo de informações</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Interface de consulta instantânea baseada em GraphRAG, com indexação otimizada para extração rápida de atributos de nós e fatos discretos</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Entrevista autônoma, capaz de conduzir diálogos paralelos em múltiplas rodadas com indivíduos do mundo simulado, coletando dados de opinião não estruturados e estados psicológicos</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Resumo</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Converse com o Report Agent para explorar o conteúdo do relatório' : 'Converse com indivíduos simulados para conhecer suas opiniões' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Digite a pergunta que deseja fazer a todos os participantes selecionados..."
                rows="3"
              ></textarea>
            </div>
...
// Salvar histórico de conversa atual no cache
...
const selectReportAgentChat = () => {
  // Salvar histórico de conversa atual
  saveChatHistory()
  ...
  // Restaurar histórico de conversa do Report Agent
...
const selectAgent = (agent, idx) => {
  ...
  // Restaurar histórico de conversa deste Agent
...
const renderMarkdown = (content) => {
  ...
  // Limpar <p><br> seguidos de elementos de bloco (causados por linhas em branco extras)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Limpar tags <br> consecutivas
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Limpar <br> entre elemento de bloco e tag de abertura de parágrafo
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Corrigir numeração de listas ordenadas não contíguas: manter numeração crescente quando <ol> de item único são separados por conteúdo
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Salvar histórico de conversa automaticamente no cache
    saveChatHistory()
  }
}
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Selecione primeiro um indivíduo simulado')
  }
  
  addLog(`Enviado a ${selectedAgent.value.username}: ${message.substring(0, 50)}...`)
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .join('\n')
    prompt = `Aqui está nossa conversa anterior:\n${historyContext}\n\nMinha nova pergunta é：${message}`
  }
  ...
  if (res.success && res.data) {
    ...
    // Converter dicionário de objetos em array, priorizando respostas da plataforma reddit
...
const submitSurvey = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Recebidas ${surveyResults.value.length} respostas`)
    } else {
      throw new Error(res.error || 'Falha na requisição')
    }
  } catch (err) {
    addLog(`Falha no envio do questionário: ${err.message}`)
  } finally {
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Carregados ${profiles.value.length} indivíduos simulados`)
    }
  } catch (err) {
...
// Lifecycle
onMounted(() => {
  addLog('Step5 Inicialização da interação aprofundada')
  loadReportData()
  loadProfiles()
...
/* Corrigir numeração de lista ordenada - usar contadores CSS para numeração contínua entre múltiplos ol */
.message-text {
...
/* Estilo de citação na área de chat/questionário */
