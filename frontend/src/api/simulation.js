...
/**
 * Obter Profiles de Agent da simulação
 * @param {string} simulationId
 ...
 * @param {string} simulationId
 * @returns {Promise} Retorna informações de configuração, contendo metadados e conteúdo da configuração
 */
...
/**
 * Obter status detalhado da simulação (incluindo ações recentes)
 * @param {string} simulationId
 */
...
/**
 * Obter timeline da simulação (agrupado por rodada)
 * @param {string} simulationId
 ...
 * Para exibição de projetos históricos na página inicial
